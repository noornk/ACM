...
volumn_size = img_resize
input_image_z = slices
image_shape1 = 256
image_shape2 = 256
## set up logger

# all_path_input = "/workspace/SL/All_dev/image/*_input.npy"
# all_path_mask = "/workspace/SL/All_dev/mask/*_mask.npy"
# all_path_seg = "/workspace/SL/All_dev/segmented/*_seg.npy"

# all_path_input = "/workspace/stare/train/image/*.ppm"
# all_path_mask = "/workspace/stare/train/mask/*.ppm"
# all_path_seg = "/workspace/stare/train/image/*_seg_boo1.npy"

# all_path_input = "/workspace/chase/image/*.jpg"
# all_path_mask = "/workspace/chase/mask/*.png"
# all_path_seg = "/workspace/chase/image/*_seg_boo1.npy"

all_path_input = "/workspace/training/test/images/*.tif"
all_path_mask = "/workspace/training/test/mask/*.gif"
# all_path_seg = "/workspace/training/test/sam/*_seg_boo1.npy"
all_path_seg = "/workspace/training/test/sam/*_raw.npy"
# all_path_seg = "/workspace/training/test/sam/*_seg_hist_fft.npy"
# all_path_seg = "/workspace/training/test/sam/*_seg_hist_matched.npy"
...
for i in range(len(img_paths)):
    ...
    image = load_image(img_paths[i], 1, False)[:, :, :, 0]
    image = torch.from_numpy(image/image.max())
    image_shape1 = image.shape[1]
    image_shape2 = image.shape[2]
    out_seg = torch.from_numpy(load_image(seg_paths[i], 1, False))
    gt_mask = labels
    ...
    seg_out_acm = active_contour_layer([x_acm, dt_trans, map_lambda1, map_lambda2])
